...
public class KeySixFloor : MonoBehaviour
{
        ...
        if (IsColliding == true && Input.GetKeyDown(KeyCode.E))
        {
            ...
            if (KeyNum == 0)
            {
                if (movementScript.HasKey == 1)
                {
                    ...
                    KeyWhite.transform.position = new Vector3(22, 89, 0);
                ...
                if (movementScript.HasKey == 2)
                {
                    KeyNum = 2;
                    movementScript.HasKey = 0;
                    KeyGreen.transform.position = new Vector3(22, 89, 0);
                ...
                if (movementScript.HasKey == 3)
                {
                    KeyNum = 3;
                    movementScript.HasKey = 0;
                    KeyBlue.transform.position = new Vector3(22, 89, 0);
                ...
                if (movementScript.HasKey == 4)
                {
                    KeyNum = 4;
                    movementScript.HasKey = 0;
                    KeyRed.transform.position = new Vector3(22, 89, 0);
                ...
                if (movementScript.HasKey == 5)
                {
                    KeyNum = 5;
                    movementScript.HasKey = 0;
                    KeyYellow.transform.position = new Vector3(22, 89, 0);
